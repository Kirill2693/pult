...
QT_MOC_LITERAL(3, 20, 3), // "DRK"
QT_MOC_LITERAL(4, 24, 8), // "sendData"
QT_MOC_LITERAL(5, 33, 9), // "resivData"
QT_MOC_LITERAL(6, 43, 17), // "GetDataFromMatlab"
QT_MOC_LITERAL(7, 61, 8) // "MoveParm"

    },
    "Communication\0send\0\0DRK\0sendData\0"
    "resivData\0GetDataFromMatlab\0MoveParm"
};
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< DRK(*)>(_a[1]))); break;
        case 1: _t->resivData(); break;
        case 2: { MoveParm _r = _t->GetDataFromMatlab();
            if (_a[0]) *reinterpret_cast< MoveParm*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
}
